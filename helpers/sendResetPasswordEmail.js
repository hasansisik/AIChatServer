...
const sendResetPasswordEmail = async ({ name, email, passwordToken }) => {
    ...
    <head>
      ...
      <title>Şifre Sıfırlama - Kamila</title>
    </head>
            ...
            <table role="presentation" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); overflow: hidden;">
              ...
              <tr>
                <td style="background-color: #764ba2; padding: 40px 30px; text-align: center;">
                  ...
                  <p style="margin: 10px 0 0 0; color: #ffffff; font-size: 14px; opacity: 0.9;">Şifre Sıfırlama</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 40px 30px;">
                  ...
                  <p style="margin: 0 0 20px 0; color: #666666; font-size: 16px; line-height: 1.6;">
                    Kamila hesabınızın şifresini sıfırlamak için aşağıdaki doğrulama kodunu kullanabilirsiniz.
                  </p>
                    ...
                    <tr>
                      <td align="center" style="padding: 0;">
                        <div style="background-color: #764ba2; border-radius: 12px; padding: 30px; text-align: center; box-shadow: 0 4px 12px rgba(118, 75, 162, 0.3);">
                          <p style="margin: 0 0 10px 0; color: #ffffff; font-size: 14px; font-weight: 500; text-transform: uppercase; letter-spacing: 1px;">Şifre Sıfırlama Kodu</p>
                          <p style="margin: 0; color: #ffffff; font-size: 36px; font-weight: 700; letter-spacing: 8px; font-family: 'Courier New', monospace;">${passwordToken}</p>
                        </div>
                      </td>
                    </tr>
                  </table>
                  ...
                  <p style="margin: 20px 0 0 0; color: #999999; font-size: 14px; line-height: 1.6;">
                    Bu kod 10 dakika süreyle geçerlidir. Eğer bu işlemi siz yapmadıysanız, bu e-postayı görmezden gelebilirsiniz ve hesabınız güvende kalacaktır.
                  </p>
                  
                  <div style="margin-top: 30px; padding: 20px; background-color: #fff3cd; border-left: 4px solid #ffc107; border-radius: 4px;">
                    <p style="margin: 0; color: #856404; font-size: 14px; line-height: 1.6;">
                      <strong>Güvenlik Uyarısı:</strong> Şifre sıfırlama kodunuzu kimseyle paylaşmayın. Kamila hiçbir zaman sizden şifre veya doğrulama kodunuzu istemez.
                    </p>
                  </div>
                </td>
              </tr>
  ...
  `;
    ...
    return sendEmail({
        to: email,
        subject: 'Kamila - Şifre Sıfırlama Kodu',
        html: htmlTemplate,
    });
};
